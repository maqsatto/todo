    ...
    <div className='flex justify-between items-center font-meduim py-5'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
          ...
          <Link to="/login" className='font-[500] text-[20px] bg-orange-400 rounded py-[5px] text-white px-[25px] transition-all duration-200 ease-linear hover:bg-orange-500'> LogIn </Link>
        </div>

        <img src={assets.menu_icon} alt="menu_icon" className='flex sm:hidden w-5 cursor-pointer'
